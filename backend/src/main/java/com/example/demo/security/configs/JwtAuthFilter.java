...
import com.example.demo.shared.dto.ApiErrorResponse;
...
public class JwtAuthFilter extends OncePerRequestFilter{
    ...
    public JwtAuthFilter(UserDetailsServiceImpl userDetailsServiceImpl, ObjectMapper objectMapper, JwtHelper jwtHelper){
...
//      If any accessToken is present, then it will validate the token and then authenticate 
//      the request in security context
